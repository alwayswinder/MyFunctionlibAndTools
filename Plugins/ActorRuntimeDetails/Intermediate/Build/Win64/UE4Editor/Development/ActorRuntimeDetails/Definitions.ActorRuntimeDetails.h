#undef ACTORRUNTIMEDETAILS_API
#undef ACTORRUNTIMEDETAILS_VTABLE
...
#define ACTORRUNTIMEDETAILS_VTABLE DLLEXPORT_VTABLE
#define ACTORRUNTIMEDETAILS_API DLLEXPORT
