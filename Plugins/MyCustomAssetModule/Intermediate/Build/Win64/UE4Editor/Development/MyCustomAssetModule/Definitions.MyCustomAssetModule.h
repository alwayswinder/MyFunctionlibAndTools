#undef MYCUSTOMASSETMODULE_API
#undef MYCUSTOMASSETMODULE_VTABLE
...
#define MYCUSTOMASSETMODULE_VTABLE DLLEXPORT_VTABLE
#define MYCUSTOMASSETMODULE_API DLLEXPORT
